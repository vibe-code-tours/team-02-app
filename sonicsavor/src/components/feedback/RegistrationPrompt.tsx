  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <h2 className="text-xl font-bold text-[#FFFFFE] mb-2">
      ...
      <div className="bg-[#1A1A2E] border border-[#232946] rounded-xl p-4">
        <h3 className="text-sm font-medium text-[#FFFFFE] mb-3">
          Member Benefits
        </h3>
        <ul className="space-y-2">
          {[
            ...
            <li
              key={benefit}
              className="flex items-center gap-2 text-sm text-[#94A1B2]"
            >
              <svg
                className="w-4 h-4 text-[#2CB67D]"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
      ...
      <button
        onClick={onSkip}
        className="w-full py-3 text-[#94A1B2] hover:text-[#FFFFFE] transition-colors duration-200 text-sm cursor-pointer"
      >
        Skip for now
      </button>
    </div>
