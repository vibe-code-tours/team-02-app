...
function ToggleButton({
  ...
  const colors = {
    yes: {
      ...
      inactive: "bg-zinc-50 text-zinc-500 border-zinc-200 hover:bg-zinc-100 dark:bg-stone-800 dark:text-stone-400 dark:border-stone-800 dark:hover:bg-stone-800",
    },
    no: {
    ...
    >
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {/* Would Recommend */}
          <div>
            <p className="text-sm font-semibold text-zinc-700 dark:text-stone-300 mb-3">
