...
```
src/app/
├── page.tsx                    ← Landing (Hero + OTP entry)
├── otp/page.tsx                ← OTP verification (alternative)
...
**Purpose:** Visual intro with animated gradient and tagline

**Props:**
```typescript
interface HeroSectionProps {
  children?: React.ReactNode; // Form goes here
}
```
